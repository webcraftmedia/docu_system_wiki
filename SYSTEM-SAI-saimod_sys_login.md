...
### sai_mod__SYSTEM_SAI_saimod_sys_login
    ...
    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login()
...
### sai_mod__SYSTEM_SAI_saimod_sys_login_action_logout
    ...
    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login_action_logout()
...
### sai_mod__SYSTEM_SAI_saimod_sys_login_action_login

    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login_action_login($username, $password_sha, $password_md5)
...
### sai_mod__SYSTEM_SAI_saimod_sys_login_action_register

    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login_action_register($username, $password, $email, $locale)
...
### sai_mod__SYSTEM_SAI_saimod_sys_login_action_userinfo
    ...
    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login_action_userinfo()
...
### sai_mod__SYSTEM_SAI_saimod_sys_login_action_registerform
    ...
    mixed SYSTEM\SAI\saimod_sys_login::sai_mod__SYSTEM_SAI_saimod_sys_login_action_registerform()
...
### js
    ...
    mixed SYSTEM\SAI\saimod_sys_login::js()
